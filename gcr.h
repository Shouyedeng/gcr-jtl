...
typedef struct pin
{
    ...
    bool isSrc; //to mark whether this pin is source of a net
    bool isSink; //to mark whether this pin is sink of a net
    /*
...
{
    short		 direction; //NU ND NL NR
	unsigned short 		 **path; //jtl path array, size = ch->width * ch->length
...
/* Sets these bits to denote net direction  */
#define NU 0x0001   //net goes upwards
#define ND 0x0002   //net goes down
#define NL 0x0004   //net goes left
#define NR 0x0008   //net goes right

/* Sets these bits to denote various jtl type  */
#define JU 0x0001  //goes upwards
#define JD 0x0002  //goes down
#define JL 0x0004  //goes left
#define JR 0x0008  //goes right
#define JRU 0x0010  //goes right first then upwards, 90 degree
#define JLU 0x0020  //goes left then up, 90 degree
#define JRD 0x0040  //goes right then down, 90 degree
#define JLD 0x0080  //goes left then down, 90 degree
#define JDL 0x0100  //goes down then left, 90 degree
#define JUL 0x0200  //goes up then left, 90 degree
#define JDR 0x0400  //goes down then right, 90 degree
#define JUR 0x0800  //goes up then right, 90 degree
#define JXUR 0x1000 //"X" denotes crossing jtl that has two outputs
#define JXDR 0x2000  
#define JXUL 0x4000  
#define JXDL 0x8000
